...
transform_dir = "/scratch/users/lauraman/MiMA/runs/train_wavenet/"
...
print("Loading test 2xCO2 dataset into memory.")

# Test set
np_out = 40
data_dir = "/scratch/users/lauraman/MiMA/runs/2xCO2/"
test_filename = "atmos_daily_40.nc"
...
for batch in test_dataloader:
        ...
        if time_ind % 30 == 0:
            ...
            save_as = f"{model_dir}/2xCO2_predictions_epoch{epoch}_tmp_{time_ind}.nc"
...
save_as = f"{model_dir}/2xCO2_predictions_epoch{epoch}.nc"
ds = Y_pred_scaled_save.to_dataset(name = "Y_pred_scaled")
ds["Y_pred"] = Y_pred_save
ds.to_netcdf(save_as)
