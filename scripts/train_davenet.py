...
import sys
sys.path.append('../src/')
from Davenet import Wavenet
from GravityWavesDataset_Davenet import GravityWavesDataset
...
if init_epoch==0:
    ...
    my_model = Wavenet(n_in=42, n_out=n_out) #, use_dropout=use_dropout, dropout_rate=dropout_rate)
    losses =[]
    training_losses = []
    validation_losses = []
